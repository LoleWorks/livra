...
export default function HomeScreen({ navigation, route: navRoute }: Props) {
  ...
  useEffect(() => {
    ...
    // Reload when the app returns from background (covers the case where the
    // driver taps the push notification and the app resumes mid-session).
    ...
    // Reload immediately if a notification arrives while the app is in the
    // foreground (driver didn't have to tap anything).
