          ...
          <>
            ...
            <View style={s.labelCard}>
              ...
              <TextInput
                ...
                onBlur={() => awb && labelParcel(awb, labelDraft.trim())}
                onSubmitEditing={() => awb && labelParcel(awb, labelDraft.trim())}
              ...
              />
              {labelDraft.length > 0 && (
                <TouchableOpacity hitSlop={8} onPress={() => { setLabelDraft(''); awb && labelParcel(awb, '') }}>
