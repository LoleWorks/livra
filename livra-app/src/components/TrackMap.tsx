...
function buildHtml(driverLat?: number | null, driverLng?: number | null, destLat?: number | null, destLng?: number | null) {
  const centerLat = driverLat ?? destLat ?? DEFAULT_LAT
  const centerLng = driverLng ?? destLng ?? DEFAULT_LNG
...
export default function TrackMap({ driverLat, driverLng, destLat, destLng }: Props) {
