      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="space-y-8">
          ...
          <Section title="1. Operatorul de date cu caracter personal" dark={isDark}>
            <p><strong>SRL Livra</strong> (IDNO: <strong>[IDNO]</strong>), cu sediul la <strong>[Adresă completă, Chișinău, Republica Moldova]</strong>, este operatorul de date cu caracter personal prelucrate prin intermediul platformei Livra.</p>
            <p>Email de contact: <a href="mailto:contact@livra.md">contact@livra.md</a></p>
            <p>Responsabil cu Protecția Datelor (DPO): <a href="mailto:dpo@livra.md">dpo@livra.md</a></p>
          ...
          <Section title="5. Destinatarii datelor (sub-procesatori)" dark={isDark}>
            ...
            <p>Lista completă a sub-procesatorilor este disponibilă la cerere la <a href="mailto:dpo@livra.md">dpo@livra.md</a>.</p>
          </Section>
          ...
          <Section title="7. Drepturile persoanelor vizate" dark={isDark}>
            ...
            <p>Cererile privind exercitarea drepturilor se transmit la: <a href="mailto:dpo@livra.md">dpo@livra.md</a>. Vom răspunde în termen de <strong>30 de zile calendaristice</strong>.</p>
          </Section>
          ...
          <Section title="11. Responsabilul cu Protecția Datelor (DPO)" dark={isDark}>
            ...
            <ul>
              <li>Email: <a href="mailto:dpo@livra.md">dpo@livra.md</a></li>
            </ul>
          ...
          <Section title="12. Dreptul de a depune o plângere" dark={isDark}>
            ...
            <p className="mt-3">Vă încurajăm să ne contactați mai întâi la <a href="mailto:dpo@livra.md">dpo@livra.md</a> pentru a rezolva orice problemă direct.</p>
          </Section>

          <Section title="13. Actualizarea politicii" dark={isDark}>
            <p>Prezenta Politică de Confidențialitate poate fi actualizată periodic pentru a reflecta modificările legislative sau ale practicilor noastre de prelucrare. Versiunea curentă este întotdeauna disponibilă la <a href="/confidentialitate">livra.md/confidentialitate</a>.</p>
        ...
        <div className={`mt-12 pt-8 border-t ${isDark ? 'border-gray-800 text-gray-400' : 'border-gray-200 text-gray-500'} text-sm`}>
          <p>Pentru exercitarea drepturilor sau orice întrebare privind confidențialitatea datelor: <a href="mailto:dpo@livra.md" className="text-[#FF5C2C]">dpo@livra.md</a></p>
          <p className="mt-2">
